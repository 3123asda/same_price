...
#USER INPUT CODE ORIGIN AND DESTINATION SECTION

#MANILA DESTINATION FUNCTION
def manila_origin():
    print('\n============================================')
...
#USER BOOKING DATE SECTION 

#USER INPUT YEAR FUNCTION
...
#USER INPUT CODE SECTION CLASS FUNCTION
def class_passenger():
...
#PREMIUM ECONOMY CLASS FUNCTION
...
#USER TIME STAMPS CLASS CODE CATEGORY SECTION

#ECONOMY CLASS TIME STAMPS FUNCTION
def economy_time():
    while(5):
        global time
...
#PREMIUM ECONOMY CLASS TIME STAMPS FUNCTION
def premium_time():
    while(5):
        global time
...
#BUSINESS CLASS TIME STAMPS FUNCTION
def business_time():
    while(5):
        global time
...
#FIRST CLASS TIME STAMPS FUNCTION
def first_time():
    while(5):
        global time
...
#USER INPUT PAYMENT AND PASSENGER SECTION

#ECONOMY CLASS PAYMENT AND PASSENGER FUNCTION
...
#PREMIUM ECONOMY CLASS PAYMENT AND PASSENGER FUNCTION
...
#BUSINESS CLASS PAYMENT AND PASSENGER FUNCTION
...
#FIRST CLASS PAYMENT AND PASSENGER FUNCTION
...
#PREMIUM ECONOMY CLASS TICKET FUNCTION
...
#BUSINESS CLASS TICKET FUNCTION
...
#AVAILABLE ROUTE INVALID KEYWORD/CODE FUNCTION
...
#USER INPUT CHOOSE ORIGIN AND DESTINATION KEYWORD/CODE SECTION
